<template>
    ...
    <button v-on:click="onClick" class="cart-items-close">
    ...
    <div class="cart-item">
        <img :src="`${require('../assets/'+ data.img)}`" :alt="`${ data.title }`" class="cart-img">
        <div class="cart-common">
            <h2 class="cart-common-title">{{ data.title }}</h2>
            <ul class="cart-common-list">
                <li class="cart-common-list-li">Price: <span class="cart-common-list-sp">{{ data.price }}</span>
                </li>
